...
public class FIPSApplicationStateMachineUtil {
	...
	public static void error(String failedStep, Throwable throwable) {
		FIPSApplicationState fipsApplicationState = _updateFIPSApplicationState(
			FIPSApplicationState.ERROR);

		try {
			_writeFIPSStateTransitionAuditEvent(
				fipsApplicationState, FIPSApplicationState.ERROR,
				fipsAuditEvent -> {
			...
			_log.error(
				StringBundler.concat(
					...
					"changed from \"", fipsApplicationState, "\" to \"",
