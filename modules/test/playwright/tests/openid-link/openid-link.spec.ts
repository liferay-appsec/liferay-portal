...
} from "../../fixtures/singleSignOnSettingsPagesTest";
import performLogin from "../../utils/performLogin";
import { utilityPagesPage } from '../login-web/fixtures/utilityPageTest';
import {
    SingleSignOnSettingsPage
} from "../../pages/portal-settings-authentication-openid-connect-web/SingleSignOnSettingsPage";
...
test.afterEach(async ({ page, loginInstanceSettingsPage, singleSignOnSettingsPage, utilityPagesPage }) => {
...
test.describe('OpenID connect link', () => {
    test(
        'is visible on sign-in page when OpenID connection is enabled on NOT an utility page',
        async ({ page, singleSignOnSettingsPage }) => {
            await performLogin(page, 'test');
    ...
    test(
        'when openId connection is enabled on an utility page, then openId connect link is hidden on sign in page', async ({
