...
public class SimpleURLPatternMapperPerformanceTest {
	...
	public void testGet() {
		...
		for (int i = 0; i < 100000; i++) {
			for (String path : pathToPatternMap.keySet()) {
				urlPatternMapper.getValue(path);
			}
		}
	...
	private Map<String, String> _createPathToPatternMap() {
		...
		pathToPatternMap.put("random/path/do/test.jsp", "*.jsp");
		pathToPatternMap.put("random/path/do/test.mp3", "*.mp3");
		...
		pathToPatternMap.put("/*", "/*/*");
		pathToPatternMap.put("/*/", "/*//*");
		pathToPatternMap.put("/do/test.mp3", "/do/test.mp3/*");
		pathToPatternMap.put("/do/test.mp3/", "/do/test.mp3/*");
		pathToPatternMap.put("/do/test.mp3/do/test", "/do/test.mp3/*");
		pathToPatternMap.put("/random/one/two/three", "/*");
		pathToPatternMap.put("/url/random/one/two/three", "/url/*");
		pathToPatternMap.put(
			"/url/some/random/pattern/do/test.mp3",
			"/url/some/random/pattern/do/test.mp3/*");
		pathToPatternMap.put(
