...
public class ResourceTypesResourceTest
	...
	public void testGetV2ResourceTypeById() throws Exception {
		...
		for (String resourceType : _resourceTypes) {
	...
	public void testGetV2ResourceTypes() throws Exception {
		...
		Assert.assertEquals(2, listResponseJSONObject.getLong("totalResults"));
		Assert.assertEquals(2, listResponseJSONObject.getLong("itemsPerPage"));
	...
	private final List<String> _resourceTypes = List.of("Group", "User");
