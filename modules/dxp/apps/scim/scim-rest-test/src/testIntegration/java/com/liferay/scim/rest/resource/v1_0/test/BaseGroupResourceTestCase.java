...
public abstract class BaseGroupResourceTestCase {
	...
	protected void assertContains(Object group, List<Object> groups) {
	...
	protected void assertEquals(Object group1, Object group2) {
		Assert.assertTrue(
			group1 + " does not equal " + group2, equals(group1, group2));
	}

	protected void assertEquals(List<Object> groups1, List<Object> groups2) {
		Assert.assertEquals(groups1.size(), groups2.size());

		for (int i = 0; i < groups1.size(); i++) {
			Object group1 = groups1.get(i);
			Object group2 = groups2.get(i);
	...
	protected void assertEqualsIgnoringOrder(
		List<Object> groups1, List<Object> groups2) {

		Assert.assertEquals(groups1.size(), groups2.size());

		for (Object group1 : groups1) {
			boolean contains = false;

			for (Object group2 : groups2) {
	...
	protected void assertValid(Object group) throws Exception {
		boolean valid = true;
	...
	protected void assertValid(
		...
		java.util.Collection<Object> groups = page.getItems();
	...
	protected boolean equals(Object group1, Object group2) {
		if (group1 == group2) {
			return true;
		}
	...
	protected String getFilterString(
		EntityField entityField, String operator, Object group) {
