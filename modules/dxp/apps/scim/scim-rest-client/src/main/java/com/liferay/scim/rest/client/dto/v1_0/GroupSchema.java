...
import com.liferay.scim.rest.client.serdes.v1_0.GroupSchemaSerDes;
 ...
 */
@Generated("")
public class GroupSchema implements Cloneable, Serializable {

	public static GroupSchema toDTO(String json) {
		return GroupSchemaSerDes.toDTO(json);
	}
	...
	@Override
	public GroupSchema clone() throws CloneNotSupportedException {
		return (GroupSchema)super.clone();
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof GroupSchema)) {
			return false;
		}

		GroupSchema groupSchema = (GroupSchema)object;

		return Objects.equals(toString(), groupSchema.toString());
	}
	...
	public String toString() {
		return GroupSchemaSerDes.toJSON(this);
	}
