...
public class Patch implements Serializable {
	...
	public static Patch toDTO(String json) {
		return ObjectMapperUtil.readValue(Patch.class, json);
	}

	public static Patch unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Patch.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.scim.rest.dto.v1_0.Patch",
		name = "x-class-name"
	)
