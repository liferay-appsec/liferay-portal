 ...
 */
@Generated("")
@GraphQLName("GroupSchema")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "GroupSchema")
public class GroupSchema implements Serializable {

	public static GroupSchema toDTO(String json) {
		return ObjectMapperUtil.readValue(GroupSchema.class, json);
	}

	public static GroupSchema unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(GroupSchema.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.scim.rest.dto.v1_0.GroupSchema",
		name = "x-class-name"
	)
