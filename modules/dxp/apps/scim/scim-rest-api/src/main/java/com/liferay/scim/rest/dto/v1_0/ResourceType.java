...
public class ResourceType implements Serializable {
	...
	@Schema(description = "The resource type's human-readable description.")
	...
	@Schema(description = "The resource type's server unique id.")
	public String getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@Schema(description = "The resource type name.")
	...
	@Schema(description = "The resource type's primary/base schema URI.")
	...
	public void setSchemas(
		UnsafeSupplier<Object[], Exception> schemasUnsafeSupplier) {
	...
	@JsonIgnore
	private Supplier<Object[]> _schemasSupplier;
