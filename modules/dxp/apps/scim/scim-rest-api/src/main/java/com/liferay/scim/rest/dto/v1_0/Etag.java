...
@XmlRootElement(name = "Etag")
public class Etag implements Serializable {

	public static Etag toDTO(String json) {
		return ObjectMapperUtil.readValue(Etag.class, json);
	}

	public static Etag unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Etag.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		Etag etag = (Etag)object;

		return Objects.equals(toString(), etag.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.scim.rest.dto.v1_0.Etag",
		name = "x-class-name"
	)
