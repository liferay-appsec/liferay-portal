...
package com.liferay.saml.opensaml.integration.internal.field.expression.handler.test;
...
public class DefaultUserFieldExpressionHandlerTest {
	...
	@Test
	public void testAllUserFieldsAreUpdatedWhenEmailContainsCapitalLetters()
		throws Exception {
	...
	@Test
	public void testAllUserFieldsAreUpdatedWhenEmailContainsLowercaseLetters()
		throws Exception {
	...
	@Test
	public void testNoUserFieldUpdatedWhenNewEmailAddressFound()
		throws Exception {
		...
		Assert.assertNotEquals(
			_currentUser.getLastName(), newUser.getLastName());
		Assert.assertNotEquals(
