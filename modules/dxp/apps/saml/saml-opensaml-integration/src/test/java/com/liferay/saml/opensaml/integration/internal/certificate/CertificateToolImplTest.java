...
public class CertificateToolImplTest {
	...
	public void setUp() throws Exception {
		...
		_x509Certificate = _certificateTool.generateCertificate(
	...
	public void testGenerateCertificate() throws Exception {
		_x509Certificate.verify(_keyPair.getPublic());

		_x509Certificate.checkValidity();

		Assert.assertEquals(
			_x509Certificate.getIssuerX500Principal(),
			_x509Certificate.getSubjectX500Principal());

		String subjectName = _certificateTool.getSubjectName(_x509Certificate);
