...
public class MFAFIDO2CredentialEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByCredentialId;
	private FinderPath _finderPathWithoutPaginationFindByCredentialId;
	private FinderPath _finderPathCountByCredentialId;

	/**
	 * Returns all the mfafido2 credential entries where credentialId = &#63;.
	 *
	 * @param credentialId the credential ID
	 * @return the matching mfafido2 credential entries
	 */
	@Override
	public List<MFAFIDO2CredentialEntry> findByCredentialId(
		String credentialId) {

		return findByCredentialId(
			credentialId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the mfafido2 credential entries where credentialId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>MFAFIDO2CredentialEntryModelImpl</code>.
	 * </p>
	...
	@Override
	public List<MFAFIDO2CredentialEntry> findByCredentialId(
		String credentialId, int start, int end) {

		return findByCredentialId(credentialId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the mfafido2 credential entries where credentialId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>MFAFIDO2CredentialEntryModelImpl</code>.
	 * </p>
	...
	public List<MFAFIDO2CredentialEntry> findByCredentialId(
		...
		return findByCredentialId(
			credentialId, start, end, orderByComparator, true);
	}
	...
	public List<MFAFIDO2CredentialEntry> findByCredentialId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByCredentialId;
				finderArgs = new Object[] {credentialId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByCredentialId;
			finderArgs = new Object[] {
				credentialId, start, end, orderByComparator
			};
		}
			...
			if ((list != null) && !list.isEmpty()) {
				for (MFAFIDO2CredentialEntry mfaFIDO2CredentialEntry : list) {
					if (!credentialId.equals(
							mfaFIDO2CredentialEntry.getCredentialId())) {
	...
	/**
	 * Returns the first mfafido2 credential entry in the ordered set where credentialId = &#63;.
	 *
	 * @param credentialId the credential ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching mfafido2 credential entry
	 ...
	 */
	@Override
	public MFAFIDO2CredentialEntry findByCredentialId_First(
			String credentialId,
			OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator)
		throws NoSuchMFAFIDO2CredentialEntryException {

		MFAFIDO2CredentialEntry mfaFIDO2CredentialEntry =
			fetchByCredentialId_First(credentialId, orderByComparator);
	 ...
	 */
	@Override
	public MFAFIDO2CredentialEntry fetchByCredentialId_First(
		String credentialId,
		OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator) {

		List<MFAFIDO2CredentialEntry> list = findByCredentialId(
			credentialId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last mfafido2 credential entry in the ordered set where credentialId = &#63;.
	 *
	 * @param credentialId the credential ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching mfafido2 credential entry
	 ...
	 */
	@Override
	public MFAFIDO2CredentialEntry findByCredentialId_Last(
			String credentialId,
			OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator)
		throws NoSuchMFAFIDO2CredentialEntryException {

		MFAFIDO2CredentialEntry mfaFIDO2CredentialEntry =
			fetchByCredentialId_Last(credentialId, orderByComparator);
	 ...
	 */
	@Override
	public MFAFIDO2CredentialEntry fetchByCredentialId_Last(
		String credentialId,
		OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator) {

		int count = countByCredentialId(credentialId);
		...
		List<MFAFIDO2CredentialEntry> list = findByCredentialId(
			credentialId, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the mfafido2 credential entries before and after the current mfafido2 credential entry in the ordered set where credentialId = &#63;.
	 *
	 * @param mfaFIDO2CredentialEntryId the primary key of the current mfafido2 credential entry
	 * @param credentialId the credential ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public MFAFIDO2CredentialEntry[] findByCredentialId_PrevAndNext(
			long mfaFIDO2CredentialEntryId, String credentialId,
			OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator)
		throws NoSuchMFAFIDO2CredentialEntryException {
		...
		try {
			...
			array[0] = getByCredentialId_PrevAndNext(
				session, mfaFIDO2CredentialEntry, credentialId,
				orderByComparator, true);

			array[1] = mfaFIDO2CredentialEntry;

			array[2] = getByCredentialId_PrevAndNext(
				session, mfaFIDO2CredentialEntry, credentialId,
	...
	protected MFAFIDO2CredentialEntry getByCredentialId_PrevAndNext(
		Session session, MFAFIDO2CredentialEntry mfaFIDO2CredentialEntry,
		String credentialId,
		OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the mfafido2 credential entries where credentialId = &#63; from the database.
	 *
	 * @param credentialId the credential ID
	 */
	@Override
	public void removeByCredentialId(String credentialId) {
		for (MFAFIDO2CredentialEntry mfaFIDO2CredentialEntry :
				findByCredentialId(
					credentialId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the mfafido2 credential entry where userId = &#63; and credentialId = &#63; or throws a <code>NoSuchMFAFIDO2CredentialEntryException</code> if it could not be found.
	 *
	 * @param userId the user ID
	 * @param credentialId the credential ID
	 ...
	 */
	@Override
	public MFAFIDO2CredentialEntry findByU_C(long userId, String credentialId)
		throws NoSuchMFAFIDO2CredentialEntryException {
	...
	/**
	 * Returns the mfafido2 credential entry where userId = &#63; and credentialId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param userId the user ID
	 * @param credentialId the credential ID
	...
	public MFAFIDO2CredentialEntry fetchByU_C(
		...
		return fetchByU_C(userId, credentialId, true);
	}

	/**
	 * Returns the mfafido2 credential entry where userId = &#63; and credentialId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param userId the user ID
	 * @param credentialId the credential ID
	 * @param useFinderCache whether to use the finder cache
	...
	@Override
	public MFAFIDO2CredentialEntry fetchByU_C(
		long userId, String credentialId, boolean useFinderCache) {
		...
		if (useFinderCache) {
			finderArgs = new Object[] {userId, credentialId};
		}
		...
		if (result == null) {
			...
			if (credentialId.isEmpty()) {
				sb.append(_FINDER_COLUMN_U_C_CREDENTIALID_3);
			}
			else {
				bindCredentialId = true;

				sb.append(_FINDER_COLUMN_U_C_CREDENTIALID_2);
			}
	...
	/**
	 * Removes the mfafido2 credential entry where userId = &#63; and credentialId = &#63; from the database.
	 *
	 * @param userId the user ID
	 * @param credentialId the credential ID
	 ...
	 */
	@Override
	public MFAFIDO2CredentialEntry removeByU_C(long userId, String credentialId)
		throws NoSuchMFAFIDO2CredentialEntryException {
	...
	/**
	 * Returns the number of mfafido2 credential entries where userId = &#63; and credentialId = &#63;.
	 *
	 * @param userId the user ID
	 * @param credentialId the credential ID
	 * @return the number of matching mfafido2 credential entries
	 */
	@Override
	public int countByU_C(long userId, String credentialId) {
		credentialId = Objects.toString(credentialId, "");

		FinderPath finderPath = _finderPathCountByU_C;

		Object[] finderArgs = new Object[] {userId, credentialId};
	...
	private static final String _FINDER_COLUMN_U_C_CREDENTIALID_2 =
		"mfafido2CredentialEntry.credentialId = ?";

	private static final String _FINDER_COLUMN_U_C_CREDENTIALID_3 =
		"(mfafido2CredentialEntry.credentialId IS NULL OR mfafido2CredentialEntry.credentialId = '')";
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByCredentialId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCredentialId",
			new String[] {
		...
		_finderPathWithoutPaginationFindByCredentialId = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCredentialId",
