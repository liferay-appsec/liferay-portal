...
public class MFAFIDO2CredentialEntryModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table MFAFIDO2CredentialEntry (mvccVersion LONG default 0 not null,mfaFIDO2CredentialEntryId LONG not null primary key,companyId LONG,createDate DATE null,modifiedDate DATE null,userId LONG,credentialId VARCHAR(128) null,credentialType INTEGER,publicKeyCose VARCHAR(128) null,signatureCount LONG,failedAttempts INTEGER,lastFailDate DATE null,lastFailIP VARCHAR(75) null,lastSuccessDate DATE null,lastSuccessIP VARCHAR(75) null)";
	 ...
	 */
	@Deprecated
	public static final long CREDENTIALID_COLUMN_BITMASK = 1L;
	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			(BiConsumer<MFAFIDO2CredentialEntry, String>)
				MFAFIDO2CredentialEntry::setCredentialId);
		attributeGetterFunctions.put(
		...
		attributeGetterFunctions.put(
			"lastFailDate", MFAFIDO2CredentialEntry::getLastFailDate);
		attributeSetterBiConsumers.put(
			"lastFailDate",
			(BiConsumer<MFAFIDO2CredentialEntry, Date>)
				MFAFIDO2CredentialEntry::setLastFailDate);
		attributeGetterFunctions.put(
			"lastFailIP", MFAFIDO2CredentialEntry::getLastFailIP);
		attributeSetterBiConsumers.put(
			"lastFailIP",
			(BiConsumer<MFAFIDO2CredentialEntry, String>)
				MFAFIDO2CredentialEntry::setLastFailIP);
		attributeGetterFunctions.put(
			"lastSuccessDate", MFAFIDO2CredentialEntry::getLastSuccessDate);
		attributeSetterBiConsumers.put(
			"lastSuccessDate",
			(BiConsumer<MFAFIDO2CredentialEntry, Date>)
				MFAFIDO2CredentialEntry::setLastSuccessDate);
		attributeGetterFunctions.put(
			"lastSuccessIP", MFAFIDO2CredentialEntry::getLastSuccessIP);
		attributeSetterBiConsumers.put(
			"lastSuccessIP",
			(BiConsumer<MFAFIDO2CredentialEntry, String>)
				MFAFIDO2CredentialEntry::setLastSuccessIP);
	...
	public String getOriginalCredentialId() {
		return getColumnOriginalValue("credentialId");
	}
	...
	static {
		...
		columnBitmasks.put("lastFailDate", 2048L);

		columnBitmasks.put("lastFailIP", 4096L);

		columnBitmasks.put("lastSuccessDate", 8192L);

		columnBitmasks.put("lastSuccessIP", 16384L);
