...
public class MFAFIDO2CredentialEntryLocalServiceUtil {
	...
	public static
		...
		return getService().fetchMFAFIDO2CredentialEntryByUserIdAndCredentialId(
			userId, credentialId);
	}
	...
	public static java.util.List
		<com.liferay.multi.factor.authentication.fido2.credential.model.
			MFAFIDO2CredentialEntry> getMFAFIDO2CredentialEntriesByCredentialId(
				String credentialId) {

		return getService().getMFAFIDO2CredentialEntriesByCredentialId(
			credentialId);
	}
	...
	public static void updateAttempts(
		...
		getService().updateAttempts(userId, ip, signatureCount);
	}
