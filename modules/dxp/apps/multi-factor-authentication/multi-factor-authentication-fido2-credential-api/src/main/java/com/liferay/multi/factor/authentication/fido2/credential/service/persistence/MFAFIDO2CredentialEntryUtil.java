...
public class MFAFIDO2CredentialEntryUtil {
	 ...
	 * @return the matching mfafido2 credential entries
	 */
	public static List<MFAFIDO2CredentialEntry> findByCredentialId(
		String credentialId) {
	...
	public static List<MFAFIDO2CredentialEntry> findByCredentialId(
		...
		return getPersistence().findByCredentialId(credentialId, start, end);
	}
	...
	public static List<MFAFIDO2CredentialEntry> findByCredentialId(
		...
		return getPersistence().findByCredentialId(
	...
	public static List<MFAFIDO2CredentialEntry> findByCredentialId(
		...
		return getPersistence().findByCredentialId(
			credentialId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchMFAFIDO2CredentialEntryException if a matching mfafido2 credential entry could not be found
	 */
	public static MFAFIDO2CredentialEntry findByCredentialId_First(
			String credentialId,
			OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator)
		throws com.liferay.multi.factor.authentication.fido2.credential.
			exception.NoSuchMFAFIDO2CredentialEntryException {

		return getPersistence().findByCredentialId_First(
			credentialId, orderByComparator);
	}
	 ...
	 * @return the first matching mfafido2 credential entry, or <code>null</code> if a matching mfafido2 credential entry could not be found
	 */
	public static MFAFIDO2CredentialEntry fetchByCredentialId_First(
		String credentialId,
		OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator) {

		return getPersistence().fetchByCredentialId_First(
			credentialId, orderByComparator);
	}
	 ...
	 * @throws NoSuchMFAFIDO2CredentialEntryException if a matching mfafido2 credential entry could not be found
	 */
	public static MFAFIDO2CredentialEntry findByCredentialId_Last(
			String credentialId,
			OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator)
		throws com.liferay.multi.factor.authentication.fido2.credential.
			exception.NoSuchMFAFIDO2CredentialEntryException {

		return getPersistence().findByCredentialId_Last(
			credentialId, orderByComparator);
	}
	 ...
	 * @return the last matching mfafido2 credential entry, or <code>null</code> if a matching mfafido2 credential entry could not be found
	 */
	public static MFAFIDO2CredentialEntry fetchByCredentialId_Last(
		String credentialId,
		OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator) {

		return getPersistence().fetchByCredentialId_Last(
			credentialId, orderByComparator);
	}
	 ...
	 * @throws NoSuchMFAFIDO2CredentialEntryException if a mfafido2 credential entry with the primary key could not be found
	 */
	public static MFAFIDO2CredentialEntry[] findByCredentialId_PrevAndNext(
			long mfaFIDO2CredentialEntryId, String credentialId,
			OrderByComparator<MFAFIDO2CredentialEntry> orderByComparator)
		throws com.liferay.multi.factor.authentication.fido2.credential.
			exception.NoSuchMFAFIDO2CredentialEntryException {

		return getPersistence().findByCredentialId_PrevAndNext(
			mfaFIDO2CredentialEntryId, credentialId, orderByComparator);
	}
	 ...
	 * @param credentialId the credential ID
	 */
	public static void removeByCredentialId(String credentialId) {
		getPersistence().removeByCredentialId(credentialId);
	}
	...
	public static MFAFIDO2CredentialEntry findByU_C(
		...
		return getPersistence().findByU_C(userId, credentialId);
	}
	...
	public static MFAFIDO2CredentialEntry fetchByU_C(
		...
		return getPersistence().fetchByU_C(userId, credentialId);
	}
	...
	public static MFAFIDO2CredentialEntry fetchByU_C(
		...
		return getPersistence().fetchByU_C(
			userId, credentialId, useFinderCache);
	}
	...
	public static MFAFIDO2CredentialEntry removeByU_C(
		...
		return getPersistence().removeByU_C(userId, credentialId);
	}
	 ...
	 * @return the number of matching mfafido2 credential entries
	 */
	public static int countByU_C(long userId, String credentialId) {
		return getPersistence().countByU_C(userId, credentialId);
	}
