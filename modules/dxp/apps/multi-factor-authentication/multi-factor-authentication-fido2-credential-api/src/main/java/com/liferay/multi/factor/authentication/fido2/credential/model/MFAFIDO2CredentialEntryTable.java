...
public class MFAFIDO2CredentialEntryTable
	...
	public final Column<MFAFIDO2CredentialEntryTable, Integer> failedAttempts =
		createColumn(
			...
			Column.FLAG_DEFAULT);
	public final Column<MFAFIDO2CredentialEntryTable, Date> lastFailDate =
		createColumn(
			"lastFailDate", Date.class, Types.TIMESTAMP, Column.FLAG_DEFAULT);
	public final Column<MFAFIDO2CredentialEntryTable, String> lastFailIP =
		createColumn(
			"lastFailIP", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<MFAFIDO2CredentialEntryTable, Date> lastSuccessDate =
		createColumn(
			"lastSuccessDate", Date.class, Types.TIMESTAMP,
			Column.FLAG_DEFAULT);
	public final Column<MFAFIDO2CredentialEntryTable, String> lastSuccessIP =
		createColumn(
