...
public class OAuthClientEntryUtil {
	...
	/**
	 * Returns all the o auth client entries that the user has permission to view where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @return the matching o auth client entries that the user has permission to view
	 */
	public static List<OAuthClientEntry> filterFindByC_U(
		long companyId, long userId) {
	...
	/**
	 * Returns a range of all the o auth client entries that the user has permission to view where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuthClientEntryModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the o auth client entries that the user has permissions to view where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuthClientEntryModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the o auth client entries before and after the current o auth client entry in the ordered set of o auth client entries that the user has permission to view where companyId = &#63; and userId = &#63;.
	 *
	 * @param oAuthClientEntryId the primary key of the current o auth client entry
	 * @param companyId the company ID
	 * @param userId the user ID
	 ...
	 * @throws NoSuchEntryException if a o auth client entry with the primary key could not be found
	 */
	public static OAuthClientEntry[] filterFindByC_U_PrevAndNext(
			long oAuthClientEntryId, long companyId, long userId,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws com.liferay.oauth.client.persistence.exception.
			NoSuchEntryException {
	...
	/**
	 * Returns the number of o auth client entries that the user has permission to view where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @return the number of matching o auth client entries that the user has permission to view
	...
	public static List<OAuthClientEntry> findByC_A(
		...
		return getPersistence().findByC_A(companyId, authServerIssuer);
	}
	...
	public static List<OAuthClientEntry> findByC_A(
		...
		return getPersistence().findByC_A(
			companyId, authServerIssuer, start, end);
	}
	...
	public static List<OAuthClientEntry> filterFindByC_A(
		...
		return getPersistence().filterFindByC_A(companyId, authServerIssuer);
	}
	 ...
	 * @param authServerIssuer the auth server issuer
	 */
	public static void removeByC_A(long companyId, String authServerIssuer) {
		getPersistence().removeByC_A(companyId, authServerIssuer);
	}
	 ...
	 * @return the number of matching o auth client entries
	 */
	public static int countByC_A(long companyId, String authServerIssuer) {
		return getPersistence().countByC_A(companyId, authServerIssuer);
	}
	...
	public static int filterCountByC_A(
		...
		return getPersistence().filterCountByC_A(companyId, authServerIssuer);
	}
	...
	public static OAuthClientEntry fetchByC_A_C(
		...
		return getPersistence().fetchByC_A_C(
			companyId, authServerIssuer, clientId, useFinderCache);
	}
