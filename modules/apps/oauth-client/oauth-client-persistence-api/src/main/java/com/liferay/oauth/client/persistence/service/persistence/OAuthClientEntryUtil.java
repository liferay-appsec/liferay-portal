...
public class OAuthClientEntryUtil {
	 ...
	 * @return the matching o auth client entries
	 */
	public static List<OAuthClientEntry> findByC_U(
	 ...
	 * @throws NoSuchEntryException if a matching o auth client entry could not be found
	 */
	public static OAuthClientEntry findByC_U_First(
			long companyId, long userId,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws com.liferay.oauth.client.persistence.exception.
			NoSuchEntryException {
	 ...
	 * @return the first matching o auth client entry, or <code>null</code> if a matching o auth client entry could not be found
	 */
	public static OAuthClientEntry fetchByC_U_First(
		long companyId, long userId,
		OrderByComparator<OAuthClientEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a matching o auth client entry could not be found
	 */
	public static OAuthClientEntry findByC_U_Last(
			long companyId, long userId,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws com.liferay.oauth.client.persistence.exception.
			NoSuchEntryException {
	 ...
	 * @return the last matching o auth client entry, or <code>null</code> if a matching o auth client entry could not be found
	 */
	public static OAuthClientEntry fetchByC_U_Last(
		long companyId, long userId,
		OrderByComparator<OAuthClientEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a o auth client entry with the primary key could not be found
	 */
	public static OAuthClientEntry[] findByC_U_PrevAndNext(
		...
		return getPersistence().findByC_U_PrevAndNext(
			oAuthClientEntryId, companyId, userId, orderByComparator);
	}
	...
	public static List<OAuthClientEntry> findByC_A(
		...
		return getPersistence().findByC_A(companyId, asMetadataIssuer);
	}
	...
	public static List<OAuthClientEntry> findByC_A(
		...
		return getPersistence().findByC_A(
			companyId, asMetadataIssuer, start, end);
	}
	...
	public static OAuthClientEntry[] findByC_A_PrevAndNext(
		...
		return getPersistence().findByC_A_PrevAndNext(
			oAuthClientEntryId, companyId, asMetadataIssuer, orderByComparator);
	}
	 ...
	 * @param asMetadataIssuer the as metadata issuer
	 */
	public static void removeByC_A(long companyId, String asMetadataIssuer) {
		getPersistence().removeByC_A(companyId, asMetadataIssuer);
	}
	 ...
	 * @return the number of matching o auth client entries
	 */
	public static int countByC_A(long companyId, String asMetadataIssuer) {
		return getPersistence().countByC_A(companyId, asMetadataIssuer);
	}
	...
	public static OAuthClientEntry fetchByC_A_C(
		...
		return getPersistence().fetchByC_A_C(
			companyId, asMetadataIssuer, clientId, useFinderCache);
	}
