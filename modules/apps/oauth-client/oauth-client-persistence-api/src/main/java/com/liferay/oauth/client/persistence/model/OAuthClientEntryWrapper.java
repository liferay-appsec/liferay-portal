...
public class OAuthClientEntryWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("asMetadataIssuer", getAsMetadataIssuer());
		attributes.put("clientId", getClientId());
		attributes.put("infoJSON", getInfoJSON());
		attributes.put("requestParamsJSON", getRequestParamsJSON());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String asMetadataIssuer = (String)attributes.get("asMetadataIssuer");

		if (asMetadataIssuer != null) {
			setAsMetadataIssuer(asMetadataIssuer);
		}
		...
		String requestParamsJSON = (String)attributes.get("requestParamsJSON");

		if (requestParamsJSON != null) {
			setRequestParamsJSON(requestParamsJSON);
		}
	}
	...
	/**
	 * Returns the as metadata issuer of this o auth client entry.
	 *
	 * @return the as metadata issuer of this o auth client entry
	 */
	@Override
	public String getAsMetadataIssuer() {
		return model.getAsMetadataIssuer();
	}
	...
	public String getRequestParamsJSON() {
		return model.getRequestParamsJSON();
	}
	...
	/**
	 * Sets the as metadata issuer of this o auth client entry.
	 *
	 * @param asMetadataIssuer the as metadata issuer of this o auth client entry
	 */
	@Override
	public void setAsMetadataIssuer(String asMetadataIssuer) {
		model.setAsMetadataIssuer(asMetadataIssuer);
	}
	...
	public void setRequestParamsJSON(String requestParamsJSON) {
		model.setRequestParamsJSON(requestParamsJSON);
	}
