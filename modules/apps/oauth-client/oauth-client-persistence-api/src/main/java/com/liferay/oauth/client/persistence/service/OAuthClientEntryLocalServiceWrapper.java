...
public class OAuthClientEntryLocalServiceWrapper
	...
	public java.util.List
		...
		return _oAuthClientEntryLocalService.getOAuthClientEntries(companyId);
	}
	...
	public java.util.List
		...
		return _oAuthClientEntryLocalService.getOAuthClientEntries(
			companyId, userId);
	}
	...
	public java.util.List
		...
		return _oAuthClientEntryLocalService.
			getOAuthClientEntriesByAuthServerType(companyId, authServerType);
	}
