...
public class OAuthClientEntryTable extends BaseTable<OAuthClientEntryTable> {
	...
	public final Column<OAuthClientEntryTable, String> asMetadataIssuer =
		createColumn(
			"asMetadataIssuer", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	...
	public final Column<OAuthClientEntryTable, Clob> requestParamsJSON =
		createColumn(
			"requestParamsJSON", Clob.class, Types.CLOB, Column.FLAG_DEFAULT);
