...
public class OAuthClientEntryServiceImpl
	...
	public OAuthClientEntry addOAuthClientEntry(
		...
		ModelResourcePermissionUtil.check(
			_oAuthClientEntryModelResourcePermission, getPermissionChecker(), 0,
			0, OAuthClientPersistenceActionKeys.ACTION_ADD_OAUTH_CLIENT_ENTRY);
	...
	public OAuthClientEntry deleteOAuthClientEntry(
		...
		if (oAuthClientEntry != null) {
			...
			oAuthClientEntry =
				oAuthClientEntryLocalService.deleteOAuthClientEntry(
					companyId, authServerIssuer, clientID);
		}
	...
	public List<OAuthClientEntry> getOAuthClientEntries(
		...
		return oAuthClientEntryPersistence.filterFindByC_U(companyId, userId);
	}
	...
	public List<OAuthClientEntry> getOAuthClientEntriesByAuthServerType(
		...
		try {
			...
			oAuthClientEntries = new ArrayList<>();
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OAuthClientEntryServiceImpl.class);
