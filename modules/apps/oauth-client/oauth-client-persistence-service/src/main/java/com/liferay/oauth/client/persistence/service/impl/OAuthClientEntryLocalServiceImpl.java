...
public class OAuthClientEntryLocalServiceImpl
	...
	public OAuthClientEntry addOAuthClientEntry(
		...
		String clientID = _validateAndGetClientId(
			companyId, authServerIssuer, infoJSON, requestParamsJSON, true);
		...
		oAuthClientEntry.setCompanyId(companyId);
		oAuthClientEntry.setUserId(userId);
		oAuthClientEntry.setCreateDate(new Date());
		oAuthClientEntry.setModifiedDate(new Date());
		...
		_resourceLocalService.addResources(
			oAuthClientEntry.getCompanyId(), 0, oAuthClientEntry.getUserId(),
			OAuthClientEntry.class.getName(),
	...
	public OAuthClientEntry deleteOAuthClientEntry(long oAuthClientEntryId)
		...
		OAuthClientEntry oAuthClientEntry = oAuthClientEntryPersistence.remove(
			oAuthClientEntryId);
