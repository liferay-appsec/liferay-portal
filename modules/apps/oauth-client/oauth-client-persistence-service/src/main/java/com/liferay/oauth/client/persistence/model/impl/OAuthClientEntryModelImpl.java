...
public class OAuthClientEntryModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"asMetadataIssuer", Types.VARCHAR}, {"clientId", Types.VARCHAR},
		{"infoJSON", Types.CLOB}, {"requestParamsJSON", Types.CLOB}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("asMetadataIssuer", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("clientId", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("infoJSON", Types.CLOB);
		TABLE_COLUMNS_MAP.put("requestParamsJSON", Types.CLOB);
	}

	public static final String TABLE_SQL_CREATE =
		"create table OAuthClientEntry (mvccVersion LONG default 0 not null,oAuthClientEntryId LONG not null primary key,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,asMetadataIssuer VARCHAR(128) null,clientId VARCHAR(128) null,infoJSON TEXT null,requestParamsJSON TEXT null)";
	 ...
	 */
	@Deprecated
	public static final long ASMETADATAISSUER_COLUMN_BITMASK = 1L;
	...
	private static Function<InvocationHandler, OAuthClientEntry>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			OAuthClientEntry.class.getClassLoader(), OAuthClientEntry.class,
			ModelWrapper.class);

		try {
			Constructor<OAuthClientEntry> constructor =
				(Constructor<OAuthClientEntry>)proxyClass.getConstructor(
	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			(BiConsumer<OAuthClientEntry, String>)
				OAuthClientEntry::setAsMetadataIssuer);
		...
		attributeSetterBiConsumers.put(
			"requestParamsJSON",
			(BiConsumer<OAuthClientEntry, String>)
				OAuthClientEntry::setRequestParamsJSON);
	...
	public String getAsMetadataIssuer() {
		if (_asMetadataIssuer == null) {
			return "";
		}
		else {
			return _asMetadataIssuer;
		}
	}
	...
	public void setAsMetadataIssuer(String asMetadataIssuer) {
		...
		_asMetadataIssuer = asMetadataIssuer;
	}
	 ...
	 */
	@Deprecated
	public String getOriginalAsMetadataIssuer() {
		return getColumnOriginalValue("asMetadataIssuer");
	}
	...
	public String getRequestParamsJSON() {
		if (_requestParamsJSON == null) {
			return "";
		}
		else {
			return _requestParamsJSON;
		}
	}
	...
	public void setRequestParamsJSON(String requestParamsJSON) {
		...
		_requestParamsJSON = requestParamsJSON;
	}
	...
	public Object clone() {
		...
		oAuthClientEntryImpl.setAsMetadataIssuer(getAsMetadataIssuer());
		oAuthClientEntryImpl.setClientId(getClientId());
		oAuthClientEntryImpl.setInfoJSON(getInfoJSON());
		oAuthClientEntryImpl.setRequestParamsJSON(getRequestParamsJSON());
	...
	public OAuthClientEntry cloneWithOriginalValues() {
		...
		oAuthClientEntryImpl.setAsMetadataIssuer(
			this.<String>getColumnOriginalValue("asMetadataIssuer"));
		...
		oAuthClientEntryImpl.setRequestParamsJSON(
			this.<String>getColumnOriginalValue("requestParamsJSON"));
	...
	public CacheModel<OAuthClientEntry> toCacheModel() {
		...
		oAuthClientEntryCacheModel.asMetadataIssuer = getAsMetadataIssuer();

		String asMetadataIssuer = oAuthClientEntryCacheModel.asMetadataIssuer;

		if ((asMetadataIssuer != null) && (asMetadataIssuer.length() == 0)) {
			oAuthClientEntryCacheModel.asMetadataIssuer = null;
		}
		...
		oAuthClientEntryCacheModel.requestParamsJSON = getRequestParamsJSON();

		String requestParamsJSON = oAuthClientEntryCacheModel.requestParamsJSON;

		if ((requestParamsJSON != null) && (requestParamsJSON.length() == 0)) {
			oAuthClientEntryCacheModel.requestParamsJSON = null;
		}
	...
	private String _asMetadataIssuer;
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("asMetadataIssuer", _asMetadataIssuer);
		_columnOriginalValues.put("clientId", _clientId);
		_columnOriginalValues.put("infoJSON", _infoJSON);
		_columnOriginalValues.put("requestParamsJSON", _requestParamsJSON);
	}
	...
	static {
		...
		columnBitmasks.put("asMetadataIssuer", 64L);

		columnBitmasks.put("clientId", 128L);

		columnBitmasks.put("infoJSON", 256L);

		columnBitmasks.put("requestParamsJSON", 512L);
