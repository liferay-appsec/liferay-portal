...
public class OAuthClientEntryCacheModel
	...
	public OAuthClientEntry toEntityModel() {
		...
		if (asMetadataIssuer == null) {
			oAuthClientEntryImpl.setAsMetadataIssuer("");
		}
		else {
			oAuthClientEntryImpl.setAsMetadataIssuer(asMetadataIssuer);
		}
		...
		if (requestParamsJSON == null) {
			oAuthClientEntryImpl.setRequestParamsJSON("");
		}
		else {
			oAuthClientEntryImpl.setRequestParamsJSON(requestParamsJSON);
		}
	...
	public void readExternal(ObjectInput objectInput)
		...
		asMetadataIssuer = objectInput.readUTF();
		clientId = objectInput.readUTF();
		infoJSON = (String)objectInput.readObject();
		requestParamsJSON = (String)objectInput.readObject();
	}
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (asMetadataIssuer == null) {
			...
			objectOutput.writeUTF(asMetadataIssuer);
		}
		...
		if (requestParamsJSON == null) {
			...
			objectOutput.writeObject(requestParamsJSON);
		}
	}
	...
	public String asMetadataIssuer;
	public String clientId;
	public String infoJSON;
	public String requestParamsJSON;
