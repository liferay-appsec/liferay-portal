...
public class OAuthClientAuthServerServiceHttp {
	...
	public static
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, companyId, userId, discoveryEndpoint, metadataJSON,
				type);
	...
	public static
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientAuthServerServiceUtil.class,
				"fetchOAuthClientAuthServer",
				_fetchOAuthClientAuthServerParameterTypes3);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientAuthServerServiceUtil.class,
				"getOAuthClientAuthServers",
				_getOAuthClientAuthServersParameterTypes4);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientAuthServerServiceUtil.class,
				"getOAuthClientAuthServers",
				_getOAuthClientAuthServersParameterTypes5);
	...
	public static
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientAuthServerServiceUtil.class,
				"updateOAuthClientAuthServer",
				_updateOAuthClientAuthServerParameterTypes7);
	...
	private static final Class<?>[] _fetchOAuthClientAuthServerParameterTypes3 =
		new Class[] {long.class, String.class};
	private static final Class<?>[] _getOAuthClientAuthServersParameterTypes4 =
		new Class[] {long.class, int.class, int.class};
	private static final Class<?>[] _getOAuthClientAuthServersParameterTypes5 =
		new Class[] {long.class, long.class};
	private static final Class<?>[] _getOAuthClientAuthServersParameterTypes6 =
		new Class[] {long.class, String.class};
	private static final Class<?>[]
		_updateOAuthClientAuthServerParameterTypes7 = new Class[] {
