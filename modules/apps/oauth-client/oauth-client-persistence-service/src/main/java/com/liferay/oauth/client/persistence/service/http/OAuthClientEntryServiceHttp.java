...
public class OAuthClientEntryServiceHttp {
	...
	public static com.liferay.oauth.client.persistence.model.OAuthClientEntry
			addOAuthClientEntry(
				...
				String authServerIssuer, String infoJSON,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, companyId, userId, authServerIssuer, infoJSON,
				requestParamsJSON);
	...
	public static com.liferay.oauth.client.persistence.model.OAuthClientEntry
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientEntryServiceUtil.class, "fetchOAuthClientEntry",
				_fetchOAuthClientEntryParameterTypes3);
	...
	public static java.util.List
		<com.liferay.oauth.client.persistence.model.OAuthClientEntry>
			getOAuthClientEntries(HttpPrincipal httpPrincipal, long companyId) {

		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientEntryServiceUtil.class, "getOAuthClientEntries",
				_getOAuthClientEntriesParameterTypes4);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientEntryServiceUtil.class, "getOAuthClientEntries",
				_getOAuthClientEntriesParameterTypes5);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientEntryServiceUtil.class, "getOAuthClientEntries",
				_getOAuthClientEntriesParameterTypes6);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				"getOAuthClientEntriesByAuthServerType",
				_getOAuthClientEntriesByAuthServerTypeParameterTypes7);
	...
	public static com.liferay.oauth.client.persistence.model.OAuthClientEntry
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateOAuthClientEntryParameterTypes8);
	...
	private static final Class<?>[] _fetchOAuthClientEntryParameterTypes3 =
		new Class[] {long.class, String.class, String.class};
	private static final Class<?>[] _getOAuthClientEntriesParameterTypes4 =
		new Class[] {long.class};
	private static final Class<?>[] _getOAuthClientEntriesParameterTypes5 =
		new Class[] {long.class, long.class};
	private static final Class<?>[] _getOAuthClientEntriesParameterTypes6 =
		new Class[] {long.class, String.class};
	private static final Class<?>[]
		_getOAuthClientEntriesByAuthServerTypeParameterTypes7 = new Class[] {
			long.class, String.class
		};
	private static final Class<?>[] _updateOAuthClientEntryParameterTypes8 =
