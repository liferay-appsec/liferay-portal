...
public class OAuthClientEntryPersistenceImpl
	...
	/**
	 * Returns all the o auth client entries where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public List<OAuthClientEntry> findByC_U(long companyId, long userId) {
		return findByC_U(
			companyId, userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the o auth client entries where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuthClientEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<OAuthClientEntry> findByC_U(
	...
	/**
	 * Returns an ordered range of all the o auth client entries where companyId = &#63; and userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuthClientEntryModelImpl</code>.
	 * </p>
	...
	public List<OAuthClientEntry> findByC_U(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (OAuthClientEntry oAuthClientEntry : list) {
					if ((companyId != oAuthClientEntry.getCompanyId()) ||
						(userId != oAuthClientEntry.getUserId())) {
	...
	/**
	 * Returns the first o auth client entry in the ordered set where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public OAuthClientEntry findByC_U_First(
			long companyId, long userId,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws NoSuchEntryException {

		OAuthClientEntry oAuthClientEntry = fetchByC_U_First(
	 ...
	 */
	@Override
	public OAuthClientEntry fetchByC_U_First(
		long companyId, long userId,
		OrderByComparator<OAuthClientEntry> orderByComparator) {

		List<OAuthClientEntry> list = findByC_U(
	...
	/**
	 * Returns the last o auth client entry in the ordered set where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public OAuthClientEntry findByC_U_Last(
			long companyId, long userId,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws NoSuchEntryException {

		OAuthClientEntry oAuthClientEntry = fetchByC_U_Last(
			companyId, userId, orderByComparator);
	 ...
	 */
	@Override
	public OAuthClientEntry fetchByC_U_Last(
		long companyId, long userId,
		OrderByComparator<OAuthClientEntry> orderByComparator) {
	...
	/**
	 * Returns the o auth client entries before and after the current o auth client entry in the ordered set where companyId = &#63; and userId = &#63;.
	 *
	 * @param oAuthClientEntryId the primary key of the current o auth client entry
	 * @param companyId the company ID
	 * @param userId the user ID
	 ...
	 */
	@Override
	public OAuthClientEntry[] findByC_U_PrevAndNext(
			long oAuthClientEntryId, long companyId, long userId,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws NoSuchEntryException {
		...
		try {
			...
			array[0] = getByC_U_PrevAndNext(
				session, oAuthClientEntry, companyId, userId, orderByComparator,
				true);
	...
	protected OAuthClientEntry getByC_U_PrevAndNext(
		Session session, OAuthClientEntry oAuthClientEntry, long companyId,
	...
	/**
	 * Removes all the o auth client entries where companyId = &#63; and userId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 */
	...
	/**
	 * Returns the number of o auth client entries where companyId = &#63; and userId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param userId the user ID
	 * @return the number of matching o auth client entries
	...
	/**
	 * Returns all the o auth client entries where companyId = &#63; and asMetadataIssuer = &#63;.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @return the matching o auth client entries
	 */
	@Override
	public List<OAuthClientEntry> findByC_A(
		...
		return findByC_A(
			companyId, asMetadataIssuer, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the o auth client entries where companyId = &#63; and asMetadataIssuer = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuthClientEntryModelImpl</code>.
	 * </p>
	...
	@Override
	public List<OAuthClientEntry> findByC_A(
		long companyId, String asMetadataIssuer, int start, int end) {

		return findByC_A(companyId, asMetadataIssuer, start, end, null);
	}

	/**
	 * Returns an ordered range of all the o auth client entries where companyId = &#63; and asMetadataIssuer = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>OAuthClientEntryModelImpl</code>.
	 * </p>
	...
	public List<OAuthClientEntry> findByC_A(
		...
		return findByC_A(
			companyId, asMetadataIssuer, start, end, orderByComparator, true);
	}
	...
	public List<OAuthClientEntry> findByC_A(
		...
		asMetadataIssuer = Objects.toString(asMetadataIssuer, "");
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {companyId, asMetadataIssuer};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByC_A;
			finderArgs = new Object[] {
				companyId, asMetadataIssuer, start, end, orderByComparator
			};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (OAuthClientEntry oAuthClientEntry : list) {
					if ((companyId != oAuthClientEntry.getCompanyId()) ||
						!asMetadataIssuer.equals(
							oAuthClientEntry.getAsMetadataIssuer())) {
		...
		if (list == null) {
			...
			boolean bindAsMetadataIssuer = false;

			if (asMetadataIssuer.isEmpty()) {
				sb.append(_FINDER_COLUMN_C_A_ASMETADATAISSUER_3);
			}
			else {
				bindAsMetadataIssuer = true;

				sb.append(_FINDER_COLUMN_C_A_ASMETADATAISSUER_2);
			}
			...
			try {
				...
				if (bindAsMetadataIssuer) {
					queryPos.add(asMetadataIssuer);
				}
	...
	/**
	 * Returns the first o auth client entry in the ordered set where companyId = &#63; and asMetadataIssuer = &#63;.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public OAuthClientEntry findByC_A_First(
		...
		OAuthClientEntry oAuthClientEntry = fetchByC_A_First(
			companyId, asMetadataIssuer, orderByComparator);
	...
	public OAuthClientEntry fetchByC_A_First(
		...
		List<OAuthClientEntry> list = findByC_A(
			companyId, asMetadataIssuer, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last o auth client entry in the ordered set where companyId = &#63; and asMetadataIssuer = &#63;.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public OAuthClientEntry fetchByC_A_Last(
		...
		int count = countByC_A(companyId, asMetadataIssuer);
		...
		List<OAuthClientEntry> list = findByC_A(
			companyId, asMetadataIssuer, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the o auth client entries before and after the current o auth client entry in the ordered set where companyId = &#63; and asMetadataIssuer = &#63;.
	 *
	 * @param oAuthClientEntryId the primary key of the current o auth client entry
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	...
	public OAuthClientEntry[] findByC_A_PrevAndNext(
			long oAuthClientEntryId, long companyId, String asMetadataIssuer,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws NoSuchEntryException {
		...
		try {
			...
			array[0] = getByC_A_PrevAndNext(
				session, oAuthClientEntry, companyId, asMetadataIssuer,
	...
	/**
	 * Removes all the o auth client entries where companyId = &#63; and asMetadataIssuer = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 */
	@Override
	public void removeByC_A(long companyId, String asMetadataIssuer) {
		for (OAuthClientEntry oAuthClientEntry :
				findByC_A(
					companyId, asMetadataIssuer, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the number of o auth client entries where companyId = &#63; and asMetadataIssuer = &#63;.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @return the number of matching o auth client entries
	 */
	@Override
	public int countByC_A(long companyId, String asMetadataIssuer) {
		asMetadataIssuer = Objects.toString(asMetadataIssuer, "");

		FinderPath finderPath = _finderPathCountByC_A;

		Object[] finderArgs = new Object[] {companyId, asMetadataIssuer};
	...
	private static final String _FINDER_COLUMN_C_A_ASMETADATAISSUER_2 =
		"oAuthClientEntry.asMetadataIssuer = ?";

	private static final String _FINDER_COLUMN_C_A_ASMETADATAISSUER_3 =
		"(oAuthClientEntry.asMetadataIssuer IS NULL OR oAuthClientEntry.asMetadataIssuer = '')";

	private FinderPath _finderPathFetchByC_A_C;
	private FinderPath _finderPathCountByC_A_C;

	/**
	 * Returns the o auth client entry where companyId = &#63; and asMetadataIssuer = &#63; and clientId = &#63; or throws a <code>NoSuchEntryException</code> if it could not be found.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	...
	/**
	 * Returns the o auth client entry where companyId = &#63; and asMetadataIssuer = &#63; and clientId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @param clientId the client ID
	...
	public OAuthClientEntry fetchByC_A_C(
		...
		return fetchByC_A_C(companyId, asMetadataIssuer, clientId, true);
	}

	/**
	 * Returns the o auth client entry where companyId = &#63; and asMetadataIssuer = &#63; and clientId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @param clientId the client ID
	...
	public OAuthClientEntry fetchByC_A_C(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {companyId, asMetadataIssuer, clientId};
		}
		...
		if (result instanceof OAuthClientEntry) {
			...
			if ((companyId != oAuthClientEntry.getCompanyId()) ||
				!Objects.equals(
					asMetadataIssuer, oAuthClientEntry.getAsMetadataIssuer()) ||
		...
		if (result == null) {
			...
			if (asMetadataIssuer.isEmpty()) {
				sb.append(_FINDER_COLUMN_C_A_C_ASMETADATAISSUER_3);
			}
			else {
				bindAsMetadataIssuer = true;

				sb.append(_FINDER_COLUMN_C_A_C_ASMETADATAISSUER_2);
			}
	...
	/**
	 * Removes the o auth client entry where companyId = &#63; and asMetadataIssuer = &#63; and clientId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @param clientId the client ID
	...
	/**
	 * Returns the number of o auth client entries where companyId = &#63; and asMetadataIssuer = &#63; and clientId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param asMetadataIssuer the as metadata issuer
	 * @param clientId the client ID
	...
	private static final String _FINDER_COLUMN_C_A_C_ASMETADATAISSUER_2 =
		"oAuthClientEntry.asMetadataIssuer = ? AND ";

	private static final String _FINDER_COLUMN_C_A_C_ASMETADATAISSUER_3 =
		"(oAuthClientEntry.asMetadataIssuer IS NULL OR oAuthClientEntry.asMetadataIssuer = '') AND ";
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			...
			oAuthClientEntryModelImpl.getAsMetadataIssuer(),
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_A = new FinderPath(
			...
			new String[] {"companyId", "asMetadataIssuer"}, true);
		...
		_finderPathCountByC_A = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "asMetadataIssuer"}, false);
		...
		_finderPathFetchByC_A_C = new FinderPath(
			...
			new String[] {"companyId", "asMetadataIssuer", "clientId"}, true);
		...
		_finderPathCountByC_A_C = new FinderPath(
			...
			new String[] {"companyId", "asMetadataIssuer", "clientId"}, false);
