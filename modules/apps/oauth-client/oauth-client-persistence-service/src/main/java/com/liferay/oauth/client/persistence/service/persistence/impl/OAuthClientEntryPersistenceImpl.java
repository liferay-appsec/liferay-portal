...
public class OAuthClientEntryPersistenceImpl
	 ...
	 */
	@Override
	public List<OAuthClientEntry> filterFindByC_U(long companyId, long userId) {
	 ...
	 */
	@Override
	public List<OAuthClientEntry> filterFindByC_U(
		long companyId, long userId, int start, int end) {
	 ...
	 */
	@Override
	public OAuthClientEntry[] filterFindByC_U_PrevAndNext(
			long oAuthClientEntryId, long companyId, long userId,
			OrderByComparator<OAuthClientEntry> orderByComparator)
		throws NoSuchEntryException {
	...
	protected OAuthClientEntry filterGetByC_U_PrevAndNext(
		Session session, OAuthClientEntry oAuthClientEntry, long companyId,
		long userId, OrderByComparator<OAuthClientEntry> orderByComparator,
		boolean previous) {
