...
@GraphQLName(
	...
	value = "ConsentPreference"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ConsentPreference")
public class ConsentPreference implements Serializable {

	public static ConsentPreference toDTO(String json) {
		return ObjectMapperUtil.readValue(ConsentPreference.class, json);
	}

	public static ConsentPreference unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ConsentPreference.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The consent preference ID."
	)
	public Long getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@GraphQLField(description = "The consent preference ID.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	protected Long id;
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), consentPreference.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.user.dto.v1_0.ConsentPreference",
		name = "x-class-name"
	)
