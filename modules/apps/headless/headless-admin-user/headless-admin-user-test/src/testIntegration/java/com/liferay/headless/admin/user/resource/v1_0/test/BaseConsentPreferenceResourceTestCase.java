...
import com.liferay.headless.admin.user.client.resource.v1_0.ConsentPreferenceResource;
import com.liferay.headless.admin.user.client.serdes.v1_0.ConsentPreferenceSerDes;
...
public abstract class BaseConsentPreferenceResourceTestCase {
	...
	public void testDeleteConsentPreferences() throws Exception {
		...
		assertHttpResponseStatusCode(
			404, consentPreferenceResource.getConsentPreferencesHttpResponse());
		assertHttpResponseStatusCode(
			404, consentPreferenceResource.getConsentPreferencesHttpResponse());
	}
	...
	@Test
	public void testGetConsentPreferences() throws Exception {
		...
		ConsentPreference consentPreference1 =
			testGetConsentPreferences_addConsentPreference(
		...
		page = consentPreferenceResource.getConsentPreferences();
		...
		assertValid(page, testGetConsentPreferences_getExpectedActions());
	}

	protected Map<String, Map<String, String>>
			testGetConsentPreferences_getExpectedActions()
		throws Exception {
	...
	protected ConsentPreference testGetConsentPreferences_addConsentPreference(
			ConsentPreference consentPreference)
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.admin.user.dto.v1_0.ConsentPreference.
						class)) {
	...
	@Inject
	private
		com.liferay.headless.admin.user.resource.v1_0.ConsentPreferenceResource
