...
import com.liferay.portal.remote.cors.internal.TrieURLToCORSSupportMapperFactory;
...
public class PortalCORSServletFilter
	...
	private URLToCORSSupportMapper _buildDefaultURLToCORSSupportMapper() {
		...
		return TrieURLToCORSSupportMapperFactory.create(corsSupports);
	}
	...
	private void _rebuild() {
		...
		if (corsSupports.isEmpty()) {
			...
			_urlToCORSSupportMappers.put(
				CompanyConstants.SYSTEM,
				TrieURLToCORSSupportMapperFactory.create(corsSupports));
		}
	...
	private void _rebuild(long companyId) {
		...
		_urlToCORSSupportMappers.put(
			companyId, TrieURLToCORSSupportMapperFactory.create(corsSupports));
	}
