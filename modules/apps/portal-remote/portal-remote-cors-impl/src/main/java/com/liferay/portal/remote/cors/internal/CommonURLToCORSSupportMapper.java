 ...
 */
public class CommonURLToCORSSupportMapper extends BaseURLToCORSSupportMapper {

	public CommonURLToCORSSupportMapper(Map<String, CORSSupport> corsSupports) {
