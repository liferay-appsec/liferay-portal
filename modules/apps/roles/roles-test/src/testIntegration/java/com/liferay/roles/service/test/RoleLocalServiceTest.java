...
public class RoleLocalServiceTest {
	...
	public void testGetGroupRolesAndTeamRoles() throws Exception {
		...
		List<Role> actualRoles = _roleLocalService.getGroupRolesAndTeamRoles(
			companyId, null, null, null, excludedRoleNames, roleTypes, 0,
	...
	public void testGetGroupRolesAndTeamRolesWithKeyword() throws Exception {
		...
		Assert.assertEquals(
			1,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordRole, keywordRole, null, excludedRoleNames,
				roleTypes, 0, groupId));
		...
		Assert.assertEquals(
			1,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordRole, keywordRole, keywordRole,
				excludedRoleNames, roleTypes, 0, groupId));

		roles = _roleLocalService.getGroupRolesAndTeamRoles(
			companyId, keywordRole, keywordRole, keywordRole, excludedRoleNames,
			roleTypes, 0, groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
		...
		Assert.assertEquals(
			1,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordTeam, keywordTeam, null, excludedRoleNames,
				roleTypes, 0, groupId));
		...
		Assert.assertEquals(
			2,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordTeam, keywordTeam, keywordTeam,
				excludedRoleNames, roleTypes, 0, groupId));

		roles = _roleLocalService.getGroupRolesAndTeamRoles(
			companyId, keywordTeam, keywordTeam, keywordTeam, excludedRoleNames,
			roleTypes, 0, groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
