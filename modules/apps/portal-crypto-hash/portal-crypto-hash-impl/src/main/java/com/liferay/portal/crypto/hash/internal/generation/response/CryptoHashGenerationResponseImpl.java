 ...
 * @author Arthur Chan
 */
public class CryptoHashGenerationResponseImpl
	implements CryptoHashGenerationResponse {

	public CryptoHashGenerationResponseImpl(
		CryptoHashFlavor cryptoHashFlavor, byte[] hash) {
