...
public class SaltCommand {
	...
	/**
	 * A command to CryptoHashGenerator to use a new salt generated from provided DefaultSizeSaltProvider
	 *
	...
	/**
	 * A command to CryptoHashGenerator to use a new salt generated from provided VariableSizeSaltProvider
	 *
