...
public class SaltCommand {
	...
	/**
	 * A command to CryptoHashProcessor to use a new salt generated from provided DefaultSizeSaltProvider
	 *
	...
	/**
	 * A command to CryptoHashProcessor to use a new salt generated from provided VariableSizeSaltProvider
	 *
