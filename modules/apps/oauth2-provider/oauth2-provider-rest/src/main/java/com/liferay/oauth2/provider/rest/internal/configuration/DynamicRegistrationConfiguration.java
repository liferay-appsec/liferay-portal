...
public interface DynamicRegistrationConfiguration {
	...
	@Meta.AD(
		deflt = "10",
		description = "dynamic-client-registration-maximum-number-of-registrations-per-hour-description",
		id = "dynamic.client.registration.maximum.number.of.registrations.per.hour",
		name = "dynamic-client-registration-maximum-number-of-registrations-per-hour",
		required = false
	)
