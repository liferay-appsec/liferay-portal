...
public class AuthorizationCodeGrantServiceRegistrator {
	...
	public static class LiferayAuthorizationCodeGrantService
		...
		public ServerAuthorizationCodeGrant getGrantRepresentation(
			...
			ServerAuthorizationCodeGrant grantRepresentation =
			...
			if (rememberDeviceCookieContent != null) {
				...
				if ((oAuth2Authorization != null) &&
					...
					Map<String, String> extraProperties =
						grantRepresentation.getExtraProperties();
					...
					grantRepresentation.setExtraProperties(extraProperties);
				}
			}
				...
				if (rememberDeviceCookieContent != null) {
					...
					if ((oAuth2Authorization != null) &&
						...
						RefreshToken refreshToken =
							_getLiferayOAuthDataProvider().getRefreshToken(
						...
						if ((refreshToken != null) &&
							...
							_getLiferayOAuthDataProvider().doRevokeRefreshToken(
								refreshToken);
		...
		protected OAuthRedirectionState recreateRedirectionStateFromParams(
			...
			Client client = _getLiferayOAuthDataProvider().getClient(
		...
		private Cookie _setRememberDeviceCookie() {
			...
			URI absolutePath = _uriInfo.getBaseUri();

			cookie.setPath(absolutePath.getPath());
