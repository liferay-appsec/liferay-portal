...
public class HttpMethodScopeLogic implements ScopeLogic {
	...
	public boolean check(
		...
		return check(
			scopeChecker, propertyAccessorFunction, resourceClass,
			resourceMethod, _getHttpMethod(resourceMethod));
	}

	public boolean check(
		ScopeChecker scopeChecker,
		Function<String, Object> propertyAccessorFunction,
		Class<?> resourceClass, Method resourceMethod, String requestMethod) {
