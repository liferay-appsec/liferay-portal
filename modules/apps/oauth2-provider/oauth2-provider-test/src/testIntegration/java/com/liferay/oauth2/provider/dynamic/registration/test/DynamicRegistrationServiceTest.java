...
public class DynamicRegistrationServiceTest extends BaseClientTestCase {
	...
	public void testRegisterInOpenModeWithInvalidRequest() throws Exception {
		...
		// Deny when a grant type is not allowed
		...
		// Deny when a redirect URI is blank
		...
		// Deny when a redirect URI does not match the allowed patterns
		...
		// Deny when a scope is not allowed
