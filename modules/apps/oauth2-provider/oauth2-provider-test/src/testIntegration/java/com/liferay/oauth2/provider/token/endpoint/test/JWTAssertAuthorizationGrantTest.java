...
import com.liferay.oauth2.provider.token.endpoint.util.JWTAssertionAuthorizationGrant;
import com.liferay.oauth2.provider.token.endpoint.util.JWTAssertionUtil;
...
public class JWTAssertAuthorizationGrantTest extends BaseTokenEndpointTestCase {
	...
	@Override
	protected AuthorizationGrant getDefaultAuthorizationGrant() {
		User user = null;
	...
	private static class JWTBearerGrantTestPreparatorBundleActivator
		...
		protected void prepareTest() throws Exception {
			...
			createOAuth2Application(
				...
				Arrays.asList(GrantType.JWT_BEARER), scopes);
		}
