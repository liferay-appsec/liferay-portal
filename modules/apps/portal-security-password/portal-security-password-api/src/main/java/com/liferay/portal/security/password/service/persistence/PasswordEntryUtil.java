...
public class PasswordEntryUtil {
	...
	public static PasswordEntry[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			passwordEntryId, uuid, orderByComparator);
	}
	 ...
	 * @return the matching password entries
	 */
	public static List<PasswordEntry> findByUuid_C(
	 ...
	 * @throws NoSuchEntryException if a matching password entry could not be found
	 */
	public static PasswordEntry findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<PasswordEntry> orderByComparator)
		throws com.liferay.portal.security.password.exception.
			NoSuchEntryException {
	 ...
	 * @return the first matching password entry, or <code>null</code> if a matching password entry could not be found
	 */
	public static PasswordEntry fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<PasswordEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a matching password entry could not be found
	 */
	public static PasswordEntry findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<PasswordEntry> orderByComparator)
		throws com.liferay.portal.security.password.exception.
			NoSuchEntryException {
	 ...
	 * @return the last matching password entry, or <code>null</code> if a matching password entry could not be found
	 */
	public static PasswordEntry fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<PasswordEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a password entry with the primary key could not be found
	 */
	public static PasswordEntry[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			passwordEntryId, uuid, companyId, orderByComparator);
	}
	...
	public static PasswordEntry[] findByUserId_PrevAndNext(
		...
		return getPersistence().findByUserId_PrevAndNext(
			passwordEntryId, userId, orderByComparator);
	}
	 ...
	 */
	public static PasswordEntry create(long passwordEntryId) {
		return getPersistence().create(passwordEntryId);
	}
	 ...
	 * @throws NoSuchEntryException if a password entry with the primary key could not be found
	 */
	public static PasswordEntry remove(long passwordEntryId)
		throws com.liferay.portal.security.password.exception.
			NoSuchEntryException {

		return getPersistence().remove(passwordEntryId);
	}
	 ...
	 * @throws NoSuchEntryException if a password entry with the primary key could not be found
	 */
	public static PasswordEntry findByPrimaryKey(long passwordEntryId)
		throws com.liferay.portal.security.password.exception.
			NoSuchEntryException {

		return getPersistence().findByPrimaryKey(passwordEntryId);
	}
	 ...
	 */
	public static PasswordEntry fetchByPrimaryKey(long passwordEntryId) {
		return getPersistence().fetchByPrimaryKey(passwordEntryId);
	}
