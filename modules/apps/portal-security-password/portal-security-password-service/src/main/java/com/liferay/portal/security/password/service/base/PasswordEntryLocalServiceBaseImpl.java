...
/**
 * Provides the base implementation for the password entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.security.password.service.impl.PasswordEntryLocalServiceImpl}.
 * </p>
 *
 * @author Arthur Chan
 * @see com.liferay.portal.security.password.service.impl.PasswordEntryLocalServiceImpl
 * @generated
 */
public abstract class PasswordEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PasswordEntryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PasswordEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.portal.security.password.service.PasswordEntryLocalServiceUtil</code>.
	 */
	...
	public PasswordEntry createPasswordEntry(long passwordEntryId) {
		return passwordEntryPersistence.create(passwordEntryId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return passwordEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PasswordEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return passwordEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return passwordEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return passwordEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return passwordEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PasswordEntry fetchPasswordEntry(long passwordEntryId) {
		return passwordEntryPersistence.fetchByPrimaryKey(passwordEntryId);
	}
	...
	public PasswordEntry fetchPasswordEntryByUuidAndCompanyId(
		...
		return passwordEntryPersistence.fetchByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public PasswordEntry getPasswordEntry(long passwordEntryId)
		...
		return passwordEntryPersistence.findByPrimaryKey(passwordEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(passwordEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PasswordEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("passwordEntryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PasswordEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return passwordEntryLocalService.deletePasswordEntry(
			(PasswordEntry)persistedModel);
	}

	public BasePersistence<PasswordEntry> getBasePersistence() {
		return passwordEntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return passwordEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public PasswordEntry getPasswordEntryByUuidAndCompanyId(
		...
		return passwordEntryPersistence.findByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public List<PasswordEntry> getPasswordEntries(int start, int end) {
		return passwordEntryPersistence.findAll(start, end);
	}
	...
	public int getPasswordEntriesCount() {
		return passwordEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PasswordEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		passwordEntryLocalService = (PasswordEntryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PasswordEntryLocalService.class.getName();
	}
	...
	protected PasswordEntryLocalService passwordEntryLocalService;
