...
public class ObjectDefinitionLocalServiceImpl
	...
	public ObjectDefinition updateSystemObjectDefinition(
		...
		if (ObjectDefinitionValidationThreadLocal.hasValidationErrors()) {
			_objectFieldLocalService.validateThreadLocalObjectFields(objectDefinition);
	...
	private ObjectDefinition _addObjectDefinition(
		...
		String objectDefinitionERC =
			ObjectDefinitionValidationThreadLocal.getObjectDefinitionERC();
		...
		if (objectFields != null) {
			for (ObjectField objectField : objectFields) {
				try {
					...
					if (ObjectDefinitionValidationThreadLocal.shouldThrowExceptionOnValidation()){
						throw exception;
					}
				}
			}
