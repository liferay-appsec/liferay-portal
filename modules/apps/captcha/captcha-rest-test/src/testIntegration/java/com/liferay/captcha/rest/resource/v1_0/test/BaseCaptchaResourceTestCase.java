...
public abstract class BaseCaptchaResourceTestCase {
	...
	protected void assertEquals(
		CaptchaForm captchaForm1, CaptchaForm captchaForm2) {

		Assert.assertTrue(
			captchaForm1 + " does not equal " + captchaForm2,
			equals(captchaForm1, captchaForm2));
	}
	...
	protected void assertValid(CaptchaForm captchaForm) {
		boolean valid = true;

		for (String additionalAssertFieldName :
				getAdditionalCaptchaFormAssertFieldNames()) {
	...
	protected String[] getAdditionalCaptchaFormAssertFieldNames() {
		return new String[0];
	}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("answer", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						captchaForm1.getAnswer(), captchaForm2.getAnswer())) {
			...
			if (Objects.equals("captchaToken", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						captchaForm1.getCaptchaToken(),
						captchaForm2.getCaptchaToken())) {
	...
	protected CaptchaForm randomCaptchaForm() throws Exception {
