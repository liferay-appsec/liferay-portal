...
public abstract class BaseSimpleCaptchaResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		simpleCaptcha.setCaptchaToken(regex);
		...
		Assert.assertEquals(regex, simpleCaptcha.getCaptchaToken());
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("captchaToken", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						simpleCaptcha1.getCaptchaToken(),
						simpleCaptcha2.getCaptchaToken())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("captchaToken")) {
			Object object = simpleCaptcha.getCaptchaToken();
