...
public interface SimpleCaptchaResource {
	...
	public HttpInvoker.HttpResponse postSimpleCaptchaHttpResponse(
			SimpleCaptchaForm simpleCaptchaForm)
		throws Exception;

	public void postSimpleCaptchaBatch(
			SimpleCaptchaForm simpleCaptchaForm, String callbackURL,
			Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postSimpleCaptchaBatchHttpResponse(
			SimpleCaptchaForm simpleCaptchaForm, String callbackURL,
			Object object)
		throws Exception;
	...
	public static class SimpleCaptchaResourceImpl
		...
		public void postSimpleCaptcha(SimpleCaptchaForm simpleCaptchaForm)
			...
			HttpInvoker.HttpResponse httpResponse =
				postSimpleCaptchaHttpResponse(simpleCaptchaForm);
		...
		public HttpInvoker.HttpResponse postSimpleCaptchaHttpResponse(
			...
			httpInvoker.body(simpleCaptchaForm.toString(), "application/json");
		...
		public void postSimpleCaptchaBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSimpleCaptchaBatchHttpResponse(
		...
		public HttpInvoker.HttpResponse postSimpleCaptchaBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/captcha/v1.0/simple-captcha/batch");
