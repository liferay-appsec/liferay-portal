...
public class SimpleCaptchaSerDes {
	...
	public static String toJSON(SimpleCaptcha simpleCaptcha) {
		...
		if (simpleCaptcha.getCaptchaToken() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(simpleCaptcha.getCaptchaToken()));
	...
	public static Map<String, String> toMap(SimpleCaptcha simpleCaptcha) {
		...
		if (simpleCaptcha.getCaptchaToken() == null) {
			...
			map.put(
				"captchaToken",
				String.valueOf(simpleCaptcha.getCaptchaToken()));
		}
	...
	public static class SimpleCaptchaJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "captchaToken")) {
				if (jsonParserFieldValue != null) {
					simpleCaptcha.setCaptchaToken((String)jsonParserFieldValue);
				}
			}
