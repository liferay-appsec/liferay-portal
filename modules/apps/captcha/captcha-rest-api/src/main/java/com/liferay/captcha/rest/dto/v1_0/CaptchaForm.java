 ...
 */
@Generated("")
@GraphQLName("CaptchaForm")
@JsonFilter("Liferay.Vulcan")
@Schema(requiredProperties = {"captchaToken"})
@XmlRootElement(name = "CaptchaForm")
public class CaptchaForm implements Serializable {

	public static CaptchaForm toDTO(String json) {
		return ObjectMapperUtil.readValue(CaptchaForm.class, json);
	}

	public static CaptchaForm unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(CaptchaForm.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.captcha.rest.dto.v1_0.CaptchaForm",
		name = "x-class-name"
	)
