...
public abstract class BaseAuditEventResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		auditEvent.setXRequestId(regex);
		...
		Assert.assertEquals(regex, auditEvent.getXRequestId());
	}
	...
	protected void assertValid(AuditEvent auditEvent) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("xRequestId", additionalAssertFieldName)) {
				if (auditEvent.getXRequestId() == null) {
					valid = false;
				}
	...
	protected boolean equals(AuditEvent auditEvent1, AuditEvent auditEvent2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("xRequestId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						auditEvent1.getXRequestId(),
						auditEvent2.getXRequestId())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("xRequestId")) {
			Object object = auditEvent.getXRequestId();
		...
		return new AuditEvent() {
			{
				...
				userAgent = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
				xRequestId = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
			}
		};
	}
...
// LIFERAY-REST-BUILDER-HASH:1982027101