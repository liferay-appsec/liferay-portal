...
public class AuditEvent implements Serializable {
	...
	public String getXRequestId() {
		if (_xRequestIdSupplier != null) {
			xRequestId = _xRequestIdSupplier.get();

			_xRequestIdSupplier = null;
		}
	...
	@JsonIgnore
	public void setXRequestId(
		UnsafeSupplier<String, Exception> xRequestIdUnsafeSupplier) {

		_xRequestIdSupplier = () -> {
			try {
				return xRequestIdUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _xRequestIdSupplier;
...
// LIFERAY-REST-BUILDER-HASH:307492883