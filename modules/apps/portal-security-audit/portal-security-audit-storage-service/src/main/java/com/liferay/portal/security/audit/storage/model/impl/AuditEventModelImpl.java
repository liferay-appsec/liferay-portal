...
public class AuditEventModelImpl
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"xRequestId", AuditEvent::getXRequestId);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"xRequestId",
				(BiConsumer<AuditEvent, String>)AuditEvent::setXRequestId);
	...
	public Object clone() {
		...
		auditEventImpl.setXRequestId(getXRequestId());
	...
	public AuditEvent cloneWithOriginalValues() {
		...
		auditEventImpl.setXRequestId(
			this.<String>getColumnOriginalValue("xRequestId"));
	...
	public CacheModel<AuditEvent> toCacheModel() {
		...
		auditEventCacheModel.xRequestId = getXRequestId();

		String xRequestId = auditEventCacheModel.xRequestId;

		if ((xRequestId != null) && (xRequestId.length() == 0)) {
			auditEventCacheModel.xRequestId = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("xRequestId", _xRequestId);
	}
	...
	static {
		...
		columnBitmasks.put("resourceAction", 8388608L);

		columnBitmasks.put("resourceType", 16777216L);

		columnBitmasks.put("roles", 33554432L);

		columnBitmasks.put("serverName", 67108864L);

		columnBitmasks.put("serverPort", 134217728L);

		columnBitmasks.put("sessionID", 268435456L);

		columnBitmasks.put("userAgent", 536870912L);

		columnBitmasks.put("userEmailAddress", 1073741824L);

		columnBitmasks.put("xRequestId", 2147483648L);
...
// LIFERAY-SERVICE-BUILDER-HASH:495316272