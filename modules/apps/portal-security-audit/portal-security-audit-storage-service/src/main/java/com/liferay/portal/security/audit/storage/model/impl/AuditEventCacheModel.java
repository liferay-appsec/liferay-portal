...
public class AuditEventCacheModel
	...
	public AuditEvent toEntityModel() {
		...
		if (xRequestId == null) {
			auditEventImpl.setXRequestId("");
		}
		else {
			auditEventImpl.setXRequestId(xRequestId);
		}
	...
	public void readExternal(ObjectInput objectInput)
		...
		xRequestId = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (xRequestId == null) {
			...
			objectOutput.writeUTF(xRequestId);
		}
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1148923055