...
public class AuditPseudonymPersistenceImpl
	...
	private UniquePersistenceFinder<AuditPseudonym, NoSuchPseudonymException>
		_uniquePersistenceFinderByC_CN_FC_IVH;
	...
	public AuditPseudonym fetchByC_CN_FC_IVH(
		...
		return _uniquePersistenceFinderByC_CN_FC_IVH.fetch(
			finderCache,
			new Object[] {
				companyId, contextName, fieldCategory, identityValueHash
			},
	 ...
	 */
	@Override
	public AuditPseudonym removeByC_CN_FC_IVH(
			long companyId, String contextName, String fieldCategory,
			String identityValueHash)
		throws NoSuchPseudonymException {

		AuditPseudonym auditPseudonym = findByC_CN_FC_IVH(
			companyId, contextName, fieldCategory, identityValueHash);
	 ...
	 */
	@Override
	public int countByC_CN_FC_IVH(
		long companyId, String contextName, String fieldCategory,
		String identityValueHash) {

		return _uniquePersistenceFinderByC_CN_FC_IVH.count(
			finderCache,
			new Object[] {
				companyId, contextName, fieldCategory, identityValueHash
			});
	...
	public void activate() {
		_uniquePersistenceFinderByC_CN_FC_IVH = new UniquePersistenceFinder<>(
			this,
			createUniqueFinderPath(
				FINDER_CLASS_NAME_ENTITY, "fetchByC_CN_FC_IVH",
				new String[] {
				...
				convertNullFunction(AuditPseudonym::getIdentityValueHash)),
			...
			new FinderColumn<>(
				"auditPseudonym.", "identityValueHash",
...
// LIFERAY-SERVICE-BUILDER-HASH:-1541633817