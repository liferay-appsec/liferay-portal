...
public class AuditEventSerDes {
	...
	public static String toJSON(AuditEvent auditEvent) {
		...
		if (auditEvent.getXRequestId() != null) {
			...
			sb.append(_escape(auditEvent.getXRequestId()));
	...
	public static Map<String, String> toMap(AuditEvent auditEvent) {
		...
		if (auditEvent.getXRequestId() == null) {
			map.put("xRequestId", null);
		}
		else {
			map.put("xRequestId", String.valueOf(auditEvent.getXRequestId()));
		}
	...
	public static class AuditEventJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			...
			else if (Objects.equals(jsonParserFieldName, "xRequestId")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "accountId")) {
				...
				if (jsonParserFieldValue != null) {
					auditEvent.setXRequestId((String)jsonParserFieldValue);
				}
			}
		}
...
// LIFERAY-REST-BUILDER-HASH:-1139874711