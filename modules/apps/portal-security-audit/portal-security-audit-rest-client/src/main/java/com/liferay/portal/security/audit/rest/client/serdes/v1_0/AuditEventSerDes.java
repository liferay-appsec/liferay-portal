...
public class AuditEventSerDes {
	...
	public static String toJSON(AuditEvent auditEvent) {
		...
		if (auditEvent.getMessage() != null) {
			...
			sb.append(_escape(auditEvent.getMessage()));
		...
		if (auditEvent.getServerPort() != null) {
			...
			sb.append(auditEvent.getServerPort());
		}
		...
		if (auditEvent.getSessionId() != null) {
			...
			sb.append(_escape(auditEvent.getSessionId()));
	...
	public static Map<String, String> toMap(AuditEvent auditEvent) {
		...
		if (auditEvent.getMessage() == null) {
			...
			map.put("message", String.valueOf(auditEvent.getMessage()));
		}
		...
		if (auditEvent.getServerPort() == null) {
			map.put("serverPort", null);
		}
		else {
			map.put("serverPort", String.valueOf(auditEvent.getServerPort()));
		}
		...
		if (auditEvent.getSessionId() == null) {
			...
			map.put("sessionId", String.valueOf(auditEvent.getSessionId()));
		}
	...
	public static class AuditEventJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			...
			else if (Objects.equals(jsonParserFieldName, "serverPort")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "accountEntryId")) {
				...
				if (jsonParserFieldValue != null) {
					auditEvent.setMessage((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "serverName")) {
				if (jsonParserFieldValue != null) {
				...
				if (jsonParserFieldValue != null) {
					auditEvent.setServerPort(
						Integer.valueOf((String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "sessionId")) {
				if (jsonParserFieldValue != null) {
					auditEvent.setSessionId((String)jsonParserFieldValue);
				}
			}
		}
