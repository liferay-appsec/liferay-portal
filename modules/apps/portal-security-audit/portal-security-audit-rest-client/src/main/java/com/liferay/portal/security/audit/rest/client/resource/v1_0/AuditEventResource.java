...
package com.liferay.portal.security.audit.rest.client.resource.v1_0;
 ...
 */
@Generated("")
public interface AuditEventResource {
	...
	public static class Builder {
		...
		public AuditEventResource build() {
			return new AuditEventResourceImpl(this);
		}
	...
	public static class AuditEventResourceImpl implements AuditEventResource {

		public AuditEvent getAuditEvent(Long auditEventId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getAuditEventHttpResponse(
				auditEventId);
			...
			try {
				return AuditEventSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getAuditEventHttpResponse(
				Long auditEventId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/audit/v1.0/audit-events/{auditEventId}");

			httpInvoker.path("auditEventId", auditEventId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/audit/v1.0/audit-events/export-batch");
		...
		private AuditEventResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AuditEventResource.class.getName());
