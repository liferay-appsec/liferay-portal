...
public class AuditPseudonymWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("identityValue", getIdentityValue());
		attributes.put("identityValueHash", getIdentityValueHash());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String identityValue = (String)attributes.get("identityValue");

		if (identityValue != null) {
			setIdentityValue(identityValue);
		}

		String identityValueHash = (String)attributes.get("identityValueHash");

		if (identityValueHash != null) {
			setIdentityValueHash(identityValueHash);
		}
	}
	...
	/**
	 * Returns the identity value of this audit pseudonym.
	 *
	 * @return the identity value of this audit pseudonym
	 */
	@Override
	public String getIdentityValue() {
		return model.getIdentityValue();
	}

	/**
	 * Returns the identity value hash of this audit pseudonym.
	 *
	 * @return the identity value hash of this audit pseudonym
	 */
	@Override
	public String getIdentityValueHash() {
		return model.getIdentityValueHash();
	}
	...
	/**
	 * Sets the identity value of this audit pseudonym.
	 *
	 * @param identityValue the identity value of this audit pseudonym
	 */
	@Override
	public void setIdentityValue(String identityValue) {
		model.setIdentityValue(identityValue);
	}

	/**
	 * Sets the identity value hash of this audit pseudonym.
	 *
	 * @param identityValueHash the identity value hash of this audit pseudonym
	 */
	@Override
	public void setIdentityValueHash(String identityValueHash) {
		model.setIdentityValueHash(identityValueHash);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-551049431