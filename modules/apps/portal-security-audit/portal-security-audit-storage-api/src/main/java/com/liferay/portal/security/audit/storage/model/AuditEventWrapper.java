...
public class AuditEventWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("xRequestId", getXRequestId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String xRequestId = (String)attributes.get("xRequestId");
	...
	/**
	 * Returns the x request ID of this audit event.
	 *
	 * @return the x request ID of this audit event
	 */
	@Override
	public String getXRequestId() {
		return model.getXRequestId();
	}
	...
	/**
	 * Sets the x request ID of this audit event.
	 *
	 * @param xRequestId the x request ID of this audit event
	 */
	@Override
	public void setXRequestId(String xRequestId) {
		model.setXRequestId(xRequestId);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:216904989