...
public class AuditPseudonymUtil {
	 ...
	 */
	public static AuditPseudonym findByC_CN_FC_VH(
		...
		return getPersistence().findByC_CN_FC_VH(
	 ...
	 */
	public static AuditPseudonym fetchByC_CN_FC_VH(
		long companyId, String contextName, String fieldCategory,
		String valueHash, boolean useFinderCache) {

		return getPersistence().fetchByC_CN_FC_VH(
	 ...
	 */
	public static AuditPseudonym removeByC_CN_FC_VH(
			long companyId, String contextName, String fieldCategory,
			String valueHash)
		throws com.liferay.portal.security.audit.storage.exception.
			NoSuchPseudonymException {

		return getPersistence().removeByC_CN_FC_VH(
			companyId, contextName, fieldCategory, valueHash);
	}
	 ...
	 */
	public static int countByC_CN_FC_VH(
		long companyId, String contextName, String fieldCategory,
		String valueHash) {

		return getPersistence().countByC_CN_FC_VH(
			companyId, contextName, fieldCategory, valueHash);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-723600078