...
/**
 * Provides the local service interface for AuditPseudonym. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AuditPseudonymLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AuditPseudonymLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.security.audit.storage.service.impl.AuditPseudonymLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the audit pseudonym local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuditPseudonymLocalServiceUtil} if injection and service tracking are not available.
	 */
...
// LIFERAY-SERVICE-BUILDER-HASH:1404106716