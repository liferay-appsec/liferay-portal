...
public class AuditEventTable extends BaseTable<AuditEventTable> {
	...
	public final Column<AuditEventTable, String> userEmailAddress =
		createColumn(
			...
			Column.FLAG_DEFAULT);
	public final Column<AuditEventTable, String> xRequestId = createColumn(
		"xRequestId", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
...
// LIFERAY-SERVICE-BUILDER-HASH:-208231276