...
public class UserLocalServiceTest {
	...
	protected BundleActivator getBundleActivator() {
		return new UserLocalServiceTestBundleActivator();
	}
	...
	private class TestAuditMessageProcessor implements AuditMessageProcessor {
		...
		public void process(AuditMessage auditMessage) {
			if (_eventType != null) {
				...
				if ("LOGIN_DNE".equalsIgnoreCase(_eventType)) {
					Assert.assertTrue(
						"LOGIN_DNE".equalsIgnoreCase(
					...
					Assert.assertTrue(
						"Failed to authenticate - User Does Not Exist".
					...
					Assert.assertTrue(
						"emailAddress".equalsIgnoreCase(authType));
				}
			}
		}
