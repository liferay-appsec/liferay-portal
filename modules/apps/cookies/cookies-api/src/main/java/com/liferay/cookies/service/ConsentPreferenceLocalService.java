...
/**
 * Provides the local service interface for ConsentPreference. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConsentPreferenceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ConsentPreferenceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.cookies.service.impl.ConsentPreferenceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the consent preference local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ConsentPreferenceLocalServiceUtil} if injection and service tracking are not available.
	 */
