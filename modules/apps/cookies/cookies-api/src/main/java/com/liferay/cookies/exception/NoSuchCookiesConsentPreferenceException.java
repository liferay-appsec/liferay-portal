 ...
 */
public class NoSuchCookiesConsentPreferenceException extends NoSuchModelException {
	...
	public NoSuchCookiesConsentPreferenceException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
