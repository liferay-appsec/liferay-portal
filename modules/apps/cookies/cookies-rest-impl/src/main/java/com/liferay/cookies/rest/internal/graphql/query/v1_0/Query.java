...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {consentPreferenceByName(name: ___){domain, expirationDate, id, name, userId, value}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
		description = "Retrieves the specified consent preference of the user who made the request."
	)
	public ConsentPreference consentPreferenceByName(
		...
		return _applyComponentServiceObjects(
			...
			consentPreferenceResource ->
				consentPreferenceResource.getConsentPreferenceByName(name));
	}
