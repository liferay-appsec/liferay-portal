...
public abstract class BaseConsentPreferenceResourceTestCase {
	...
	@Test
	public void testDeleteConsentPreference() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		ConsentPreference consentPreference =
			testDeleteConsentPreference_addConsentPreference();

		assertHttpResponseStatusCode(
			204,
			consentPreferenceResource.deleteConsentPreferenceHttpResponse());
	}
	...
	@Test
	public void testGraphQLDeleteConsentPreference() throws Exception {
	...
	public void testGetConsentPreferencesPage() throws Exception {
		...
		consentPreferenceResource.deleteConsentPreference();
