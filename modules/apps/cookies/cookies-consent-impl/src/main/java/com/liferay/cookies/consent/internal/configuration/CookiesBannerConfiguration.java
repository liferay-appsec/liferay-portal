...
package com.liferay.cookies.consent.internal.configuration;
...
@Meta.OCD(
	...
	id = "com.liferay.cookies.consent.internal.configuration.CookiesBannerConfiguration",
...
public interface CookiesBannerConfiguration {
	...
	@Meta.AD(
		deflt = "Accept All", name = "accept-all-button-label", required = false
	)
	public LocalizedValuesMap acceptAllButtonLabel();

	@Meta.AD(
		deflt = "Decline All", name = "decline-all-button-label",
		required = false
	)
	public LocalizedValuesMap declineAllButtonLabel();
