...
@Meta.OCD(
	...
	id = "com.liferay.cookies.consent.internal.configuration.CookiesConfiguration",
...
public interface CookiesConfiguration {
	...
	@Meta.AD(
		...
		name = "targeting-cookies-description-field", required = false
	)
	public LocalizedValuesMap targetingCookiesDescription();

	@Meta.AD(deflt = "true", name = "pre-checked", required = false)
	public boolean targetingCookiesPreChecked();
