			...
			<div class="align-items-center d-flex flex-wrap">
				...
				%>
					...
					<div class="align-items-center d-flex mb-3 mr-4">
						<aui:input checked="<%= Objects.equals(cookiesPreferenceHandlingConfigurationDisplayContext.getCookiesPreferenceHandlingIcon(), icon) %>" id="<%= icon %>" label="" name="icon" type="radio" value="<%= icon %>" wrapperCssClass="mb-0" />
