					...
					<clay:content-col>
						<label class="toggle-switch">
							<span class="toggle-switch-check-bar">
								<input class="toggle-switch-check" data-cookie-key="<%= optionalConsentCookieType.getName() %>" data-pre-checked="<%= optionalConsentCookieType.isPreChecked() %>" disabled type="checkbox" />
