...
public class CookiesPreferenceHandlingConfigurationDisplayContext {
	...
	public boolean getCookiesPreferenceHandlingEnableFloatingIcon() {
		return _cookiesConfigurationProvider.
			isCookiesPreferenceHandlingEnableFloatingIcon(_scope, _scopePK);
	}
	...
	public long getCookiesPreferenceHandlingFloatingIconImageId() {
		return _cookiesConfigurationProvider.
			getCookiesPreferenceHandlingFloatingIconImageId(_scope, _scopePK);
	}
