...
public class LDAPSSLSocketFactory extends SocketFactory {
	...
	public Socket createSocket(
			InetAddress inetAddress, int port, InetAddress localInetAddress,
			int localPort)
		throws IOException {

		return _constrain(
			(SSLSocket)_sslSocketFactory.createSocket(
				inetAddress, port, localInetAddress, localPort));
	}
	...
	@Override
	public Socket createSocket(
			String host, int port, InetAddress localInetAddress, int localPort)
		throws IOException {

		return _constrain(
			(SSLSocket)_sslSocketFactory.createSocket(
				host, port, localInetAddress, localPort));
	}
