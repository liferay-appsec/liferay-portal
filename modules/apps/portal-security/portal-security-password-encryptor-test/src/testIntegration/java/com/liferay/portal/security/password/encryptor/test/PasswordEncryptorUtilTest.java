...
public class PasswordEncryptorUtilTest {
	...
	private void _assertIsComponentEnabled(
		...
		Assert.assertEquals(
			...
			_serviceComponentRuntime.isComponentEnabled(
				_getComponentDescriptionDTO(componentName)));
	}

	private void _enableComponent(String componentName) throws Exception {
	...
	private ComponentDescriptionDTO _getComponentDescriptionDTO(
