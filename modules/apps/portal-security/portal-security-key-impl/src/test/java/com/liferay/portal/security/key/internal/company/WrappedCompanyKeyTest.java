...
public class WrappedCompanyKeyTest {
	...
	public void testParse() {
		...
		_testParse(CompanyKeyUtil.WRAPPED_KEY_PREFIX + ":alias/kek|Y2lwaGVy}");
		_testParse(
			CompanyKeyUtil.WRAPPED_KEY_PREFIX + "provider:alias/kek|Y2lwaGVy");
		_testParse(CompanyKeyUtil.WRAPPED_KEY_PREFIX + "provider:alias/kek|}");
		_testParse(CompanyKeyUtil.WRAPPED_KEY_PREFIX + "provider:alias/kek}");
		_testParse(CompanyKeyUtil.WRAPPED_KEY_PREFIX + "provider:|Y2lwaGVy}");
