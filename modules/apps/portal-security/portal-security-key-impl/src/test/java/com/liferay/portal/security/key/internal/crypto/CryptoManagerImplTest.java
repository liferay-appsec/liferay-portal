...
public class CryptoManagerImplTest {
	...
	public void setUp() {
		...
		_inject("_keyManagerProfileRegistry", _keyManagerProfileRegistry);
	...
	@Test(expected = CryptoManagerException.class)
	public void testEncryptThrowsWhenProviderInErrorState() throws Exception {
		Mockito.when(
	...
	@Test
	public void testWildcardCompanyRoutesToProfileCompanyDEK()
		throws Exception {
	...
	@Test(expected = CryptoManagerException.class)
	public void testWrapThrowsWhenProvidersDiffer() throws Exception {
		_cryptoManagerImpl.wrap(
