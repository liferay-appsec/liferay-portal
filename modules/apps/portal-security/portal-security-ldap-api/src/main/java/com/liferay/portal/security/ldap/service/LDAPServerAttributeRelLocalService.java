...
package com.liferay.portal.security.ldap.service;
...
import com.liferay.portal.security.ldap.model.LDAPServerAttributeRel;
...
/**
 * Provides the local service interface for LDAPServerAttributeRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LDAPServerAttributeRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LDAPServerAttributeRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.security.ldap.service.impl.LDAPServerAttributeRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ldap server attribute rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LDAPServerAttributeRelLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>com.liferay.portal.security.ldap.model.impl.LDAPServerAttributeRelModelImpl</code>.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
