...
@Meta.OCD(
	id = "com.liferay.portal.security.key.provider.aws.internal.configuration.AWSSecretsManagerCompanySecretProviderConfiguration",
	localization = "content/Language",
	name = "aws-secrets-manager-company-secret-provider-configuration-name"
)
public interface AWSSecretsManagerCompanySecretProviderConfiguration {

	@Meta.AD(deflt = "", name = "secret-arn-template", required = false)
